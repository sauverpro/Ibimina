...
export const updateFundTerms = (id, data) => API.put(`/funds/${id}/terms`, data);
...
export const createMemberByPresident = (data) => API.post('/members/create-by-president', data);
...
export const loanRequest = (data) => API.post('/transactions/loan-request', data);
